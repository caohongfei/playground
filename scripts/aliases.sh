...
pk() {
  ...
  rar a -hp$RAR_PASS -xLearn/00 -xLearn/VOA -xLearn/bpics -xLearn/pics -xLearn/bsnds -x*/dep/ -x*/d/ -x*/images/ -x*/sounds/ -x*/videos/ -x*/html/ -x*/picauds/ -xLearn/TiddlySaver.jar -x*.DS_Store "$file" Learn LastPace History
  mv "$file" "$BAIDU"
  cd $olddir 
}
